                                            ...
                                            <table align="center">
                                               ...
                                               <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:left">
                                                    ...
                                                    <div style="font-style:normal;padding-bottom:15px;font-family:arial;line-height:20px;text-align:left">
                                                        ...
                                                        <p><span style="font-weight:bold;font-size:16px;">Estimate Request information below:</span> </p>
                                                        ...
                                                        <p><span style="font-weight:bold;font-size:16px">Phone Number:</span> '.$telephone.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Address 1:</span> '.$address1.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Address 2:</span> '.$address2.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Property Type:</span> '.$radio1.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Building Size:</span> '.$buildingsize.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Number of Floors:</span> '.$numberoffloors.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Requested Services:</span> '.$servicecheckbox.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Additional Comments or Requests:</span> '.$sendermessage.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Image 1:</span> '.$file1.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Image 2:</span> '.$file2.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Image 3:</span> '.$file3.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Image 4:</span> '.$file4.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Image 5:</span> '.$file5.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Image 6:</span> '.$file6.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Image 7:</span> '.$file7.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Lead Source:</span> '.$leadsource.'</p>
